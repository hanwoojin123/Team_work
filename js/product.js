document.addEventListener("DOMContentLoaded", function() {
	...
	var btnMoreList = document.querySelectorAll('.btn_more');

	btnMoreList.forEach(function(btnMore) {
	...
	const btns = document.querySelectorAll('.btns_wrap button');

	btns.forEach(function(btn, index) {
		btn.addEventListener('click', function() {
			const activeBtn = document.querySelector('.btns_wrap button.active');
			const activeCont = document.querySelector('.cont_wrap > div.active');
			...
			document.querySelectorAll('.cont_wrap > div')[index].classList.add('active');
		});
	});
